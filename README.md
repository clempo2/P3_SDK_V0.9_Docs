# P3_SDK_V0.9_Docs
Original Documentation from Multimorphic P3_SDK_V0.9 without modifications.  
...
and code samples within the Guide are licensed under the [MIT License](<a href="LICENSE_CODE.txt">).

Copyright (C) 2025 Multimorphic, Inc.